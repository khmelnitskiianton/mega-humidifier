...
Корпус для электроники, а также направляющая конструкция были смоделированы(исходники в `./enclosure`), а затем распечатаны на 3D принтере.
...
Была смоделирована (исходники в `./plate`), а затем создана плата для сборки всех датчиков с помощью KiCad и FlatCam и распечатана на фрезерном станке Charly4U:

![СХЕМА](./plate/scheme_plate.png)
