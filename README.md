...
1. Конструкционная (механическая) часть
...
Электроника размещена в отдельной пластиковой коробочке. Все элементы закреплены вместе на ???

2. Электрическая (модульная) часть:
...
Сам код прошивки выполнен в программе Arduino IDE с форматом .ino.
...
1. В процессе работы увлажнителя на дисплей выводится реальное время и показания
...
1. Реализована функция "Паузы", т.е. можно нажатием кнопки Button приостановить
