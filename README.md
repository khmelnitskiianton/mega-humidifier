...
- [Github](https://github.com/khmelnitskiianton/mega-humidifier)
- [Telegram Channel](https://t.me/vapegoida)

![Poster](./media/poster/poster.jpg)
...
5. Изменение скорости работы вентилятора и мощности испарения происходит за счет вращательного регулятора и тумблера.
...
![Схема питания](./schemes/scheme_elec.png)

**[Схема](./schemes/scheme_arduino.fzz) (выполнена в Fritzing) подключения датчиков к Arduino Nano(лежит в `schemes/`):**

![Подключение датчиков](./schemes/scheme_arduino.png)

Питание всех модулей осуществляется через блок питания AC/DC IN: 100-200В, OUT: 24В & >2А.
...
+ Блок питания 24В, >2А
+ Arduino Nano
+ Вентилятор 24В (60x60x25)
+ Ультразвуковой испаритель 24В
...
[Видео](https://github.com/user-attachments/assets/03b7d397-51f3-43c1-a0f4-bfc7255fe9b3)
...
![Схема платы](./schemes/scheme_plate.png)
...
Были смоделированы (исходники в `cut/`) таблички с названиями всех элементов на корпусе для упрощения использования устройства в программе CorelDRAW и вырезаны на лазерном станке GCC Spirit GLS40. Затем размещены на корпусе с помощью жидкого клея.

![](./media/images/cut.jpg)

## Процесс сборки

![](./media/images/plate_front.jpg)
![](./media/images/plate_back.jpg)
![](./media/images/final.jpg)
![](./media/images/table.jpg)
![](./media/images/table4.jpg)
![](./media/images/table3.jpg)
![](./media/images/table2.jpg)
![](./media/images/end.jpg)

**Демонстрация работы(`media/final.mp4`)**:

[Видео](https://github.com/user-attachments/assets/1c645f1c-7396-49a5-b0d6-75ca31a28341)
